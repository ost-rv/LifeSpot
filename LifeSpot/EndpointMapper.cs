...
namespace LifeSpot
{
    public static class EndpointMapper
    {
        ...
        /// <summary>
        ///  Маппинг Image-файлов
        /// </summary>
        public static void MapImage(this IEndpointRouteBuilder builder)
        {
            var imageSliderFiles = Directory.GetFiles($"{Environment.CurrentDirectory}\\Static\\Image\\Slider", "*.jpg")
                .Select(p => Path.GetFileName(p));

            foreach (var fileName in imageSliderFiles)
            {
                builder.MapGet($"/Static/Image/Slider/{fileName}", async context =>
                {
                    var imagePath = Path.Combine(Directory.GetCurrentDirectory(), "Static", "Image", "Slider", fileName);
